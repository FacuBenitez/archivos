...
public class Ejercicio6 {
    ...
    public static void main(String[] args) {
        ...
        empleado.add(new Employee("Sebastian Rodriguez", 54642124, 6, 350));
        empleado.add(new Employee("Martin Perez", 24687368, 7, 345));
        empleado.add(new Employee("Marcos Gimenez", 94537816, 8, 550));
        empleado.add(new Employee("Mirta Ramirez", 87645210, 4, 600));
        empleado.add(new Employee("Jose Hernandez", 798546310, 5, 320));
